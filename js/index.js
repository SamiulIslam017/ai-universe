                                    ...
                                    <div class="features d-flex flex-wrap flex-sm-column flex-lg-row justify-content-between ">
                                        <div class="py-4 m-2">
                                            ...
                                            <ul style="list-style:none; padding-left:.8em;">
                                                <li class="mb-1">${value.features[1].feature_name ? value.features[1].feature_name : "No data Found"}</li>
                                                <li class="mb-1">${value.features[2].feature_name ? value.features[2].feature_name : "No data Found"}</li>
                                                <li class="mb-1">${value.features[3].feature_name ? value.features[3].feature_name : "No data Found"}</li>
                                            </ul>
                                        </div>
                                        <div class="py-4 m-2">
                                            <h3 class="fs-5 fw-bold">Integration</h3>
                                            <ul style="list-style:none; padding-left:.8em;">
                                                <li class="mb-1">${value.integrations === null || value.integrations[0] === undefined ?   "no data found" : value.integrations[0]} </li>
                                                <li class="mb-1">${value.integrations === null || value.integrations[1] === undefined ?    "" : value.integrations[1]}</li>
                                                <li class="mb-1">${value.integrations === null || value.integrations[2] === undefined ?    "" : value.integrations[2] }</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
